...
out=unique(a); |  Returns an array containing all unique values in the matrix a.
  ...
  * It still works for floating-point numbers, but this is within the precision used internally by the software so it might fail in cases where the difference between two numbers is very small (see example below).
...
[ List of commands ](/hc/en-us/articles/360037228834) , [ uniquevertices ](/hc/en-us/articles/360034406594-uniquevertices)
