...
Adds an [index monitor](/hc/en-us/articles/360034396434) that can be used to return the spatial refractive index when using an EME solver region. The EME solver object must be set as the active solver for this command to work.
