...
It is possible to create strings that contain a # symbol. Simply create the string in
the usual way, no special actions or escape characters are required. The only confusing
point is that the automatic text coloring scheme will change all text beyond the #
symbol green. This may look slightly confusing, but it will not cause any errors.
