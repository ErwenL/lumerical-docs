...
Calculates the 'straggle' of the 1D doping profile from ion implant. The script command takes the semiconductor material name, dopant type, and ion energy as input arguments.
