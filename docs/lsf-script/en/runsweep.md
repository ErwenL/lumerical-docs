...
runsweep(“type”,”burst”, burst_settings); |  Run all sweeps with the specified resource type. The settings are applied to all sweeps. An error is returned if a sweep in the list does not support Ansys Cloud Burst Compute:
