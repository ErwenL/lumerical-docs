...
out = quadtet(tet,vtx,u);  |  outputs a scalar, the integral of u on the finite element mesh, where 
  ...
  * tet: the connectivity array, Mx4, containing row entries that index the four vertices of M tetrahedra 
  * vtx: the vertex array, Nx3, containing row entries of (x,y,z) pairs that locate the N vertex points 
...
[ List of commands ](/hc/en-us/articles/360037228834) , [ interptri ](/hc/en-us/articles/360034405774-interptri) , [ quadtri ](/hc/en-us/articles/360034406394-quadtri)
