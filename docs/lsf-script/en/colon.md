...
Create a vector, then access a portion of that matrix in reverse order with the :
operator.
...
Create a matrix, then access all the element of a dimension of that matrix with the :
operator:
