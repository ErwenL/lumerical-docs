...
Exports S-parameter results from an S-parameter sweep task to a .dat file which can be loaded by the [Optical N-Port S-parameter](**%20to%20be%20defined%20**) element in INTERCONNECT.
...
The following code can be used to export S-parameter data to a Touchstone file called s_params.s4p.
...
[addsweep](/hc/en-us/articles/360034930413-addsweep), [runsweep](/hc/en-us/articles/360034931413-runsweep), [getsweepresult](/hc/en-us/articles/360034409814-getsweepresult), [S-parameter matrix sweep](/hc/en-us/articles/360034403214-S-parameter-matrix-sweep)
