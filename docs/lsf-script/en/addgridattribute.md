...
Adds a grid attribute object to the simulation environment. Grid attribute objects include:
...
The following script is an excerpt from  LCD_twist.lsf  in the [ Twisted Nematic LCD](**%20to%20be%20defined%20**) application example which defines a spatially varying liquid crystal.
