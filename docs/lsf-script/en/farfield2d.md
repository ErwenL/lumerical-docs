...
Projects a given power or field profile monitor or a rectilinear dataset to the far field to a 1 meter radius semi-circle. The electric field intensity |E|  2  is returned. Farfield2d does not use a set of linearly spaced angles for the projection, use [farfieldangle - Script command](/hc/en-us/articles/360034930653) to get the appropriate angle vector. 
