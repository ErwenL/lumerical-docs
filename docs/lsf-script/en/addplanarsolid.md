...
Adds a planar solid primitive with the specified vertices. Planar solids offer a very convenient option to create custom, complex 3D geometries. You can find more information about planar solids in this page: [ Structures - Planar solid](/hc/en-us/articles/360034901573-Structures-Planar-solid).
