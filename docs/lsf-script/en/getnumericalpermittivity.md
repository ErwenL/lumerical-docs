...
The results from getnumericalpermittivity will be different if the Broadband Fixed Angle Source Technique (BFAST) is used. Since the script function does not require a calculation being performed beforehand, the user needs to specify if the computation uses BFAST or not. See the [ BFAST page ](/hc/en-us/articles/360034902273-Source-BFAST) for more details about this technique. 
