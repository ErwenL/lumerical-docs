...
This example copies the sweep "thickness_sweep" to the clipboard and pastes it back to the "Optimizations and Sweeps" tab again. Please download the example file from the [ Parameter sweeps ](/hc/en-us/articles/360034922873-Parameter-sweeps) page Associate files.
