...
The following script commands will create a bent waveguide using 4 poles. For mode details on how the waveguide object generates the shape of the waveguide using the poles take a look at this KB page: [ Structures - Waveguide ](/hc/en-us/articles/360034382234-Structures-Waveguide) .
