...
Adds a [circle primitive](/hc/en-us/articles/360034901513) to the simulation environment. Circles denote physical objects which appear circular or ellipsoid from above. These objects are circles or ellipses in 2D, and circular or ellipsoid cylinders in 3D.
