...
Adds a [port](/hc/en-us/articles/360034396374) to an EME solver region/object. The EME solver object must be set as the active solver for this command to work.
