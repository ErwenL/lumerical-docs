...
Adds a new thermal material property to the selected material model or the selected solid alloy. A material model (in the 'materials' folder) or a solid alloy thermal material property must be selected in the object tree for this script command to work. A solid alloy may not be created as a component of a solid alloy. To add a thermal material property from the electrothermal material database, see [ addmaterialproperties ](/hc/en-us/articles/360034924933-addmaterialproperties) . For details of thermal material models, see [ Electrical/Thermal Material Models ](/hc/en-us/articles/360034919093-Electrical-Thermal-Material-Models) .
