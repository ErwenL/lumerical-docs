...
newwizard( w, h, "title");  | 
  ...
  * w and h (width and height) are specified in pixels. The minimum values for w and h are 200. 
...
In this example we will make a widget that will make 4 power monitors in the shape of a square to encase a 2D simulation. Create a new script file and add the following code to it: 
...
[ List of commands ](/hc/en-us/articles/360037228834) , [ message ](/hc/en-us/articles/360034411714-message)
