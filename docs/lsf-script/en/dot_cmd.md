...
Calculates the dot product of two matrices, which must have the same number of elements.
The dot product of matrices A and B will be computed with the following formula:
...
[ List of commands ](../lsf-script-commands-alphabetical.md) , [ cross ](./cross.md) ,
[ * ](./minus.md) , [ length ](./length.md) , [ size ](./size.md)
