...
Gets the parameter sweep/optimization/Monte Carlo/S-parameter sweep results in the form of a dataset.
...
This example shows how to get data from a parameter sweep. Please download the example file from the [ Parameter sweeps ](/hc/en-us/articles/360034922873-Parameter-sweeps) page Associate files.
...
The following script is an excerpt from the example script from [ S-parameter matrix sweep ](/hc/en-us/articles/360034403214-S-parameter-matrix-sweep) showing how to collect the results from an S-parameter sweep.
